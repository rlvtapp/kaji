...
fn rust_retry_allowed(operation: &Operation) -> String {
    match operation.method {
        ...
        | crate::ast::HttpMethod::Put
        | crate::ast::HttpMethod::Patch
        | crate::ast::HttpMethod::Delete => "true".into(),
        crate::ast::HttpMethod::Post => operation
            .parameters
            .iter()
            .find(|parameter| {
...
fn declared_error_responses(
    operation: &Operation,
) -> impl Iterator<Item = &crate::ast::OperationResponse> {
...
fn error_body_type(response: &crate::ast::OperationResponse) -> Option<String> {
    response
        .media_types
        .first()
...
mod tests {
    ...
    use super::*;
    use crate::ast::{AdditionalProperties, Field, HttpMethod, SchemaKind, SchemaValue};
    use crate::{
