...
use kaji_core::ast::{AdditionalProperties, Api, Operation, SchemaKind, SchemaValue};
...
impl CodegenPlugin for TypeScriptSwr {
    ...
    fn generate(&self, api: &Api, config: &GeneratorConfig) -> Result<Vec<GeneratedFile>> {
        ...
        for operation in &api.operations {
            if !matches!(operation.method, kaji_core::ast::HttpMethod::Get) {
                continue;
            }
...
mod tests {
    use super::*;
    use kaji_core::ast::{Field, HttpMethod, Schema};
